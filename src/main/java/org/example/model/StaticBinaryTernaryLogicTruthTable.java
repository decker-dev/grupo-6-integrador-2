...
public class StaticBinaryTernaryLogicTruthTable implements BinaryTernaryLogicTruthTable {
    private static final int CAPACITY = 9;  // 9 combinaciones para {0,1,2}x{0,1,2}
    // Cada fila: [clave, output, input1, input2]
    // Se codifica la pareja como: clave = 10*input1 + input2.
    private int[][] data;
    private int count;

    public StaticBinaryTernaryLogicTruthTable() {
